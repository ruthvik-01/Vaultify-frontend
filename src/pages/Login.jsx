          ...
          <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
            ...
            >
              ...
              <div className="mb-5 flex items-center space-x-2.5">
                ...
                <h4 className="font-serif font-bold text-brand-charcoal text-base">Sign in with Google</h4>
              </div>
              <p className="text-xs text-gray-500 mb-5 font-sans">to continue to <strong className="text-brand-charcoal font-bold">Vaultify</strong></p>
